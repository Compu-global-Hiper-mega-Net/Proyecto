...
public class Grupo {
     ...
     * @param gNuevo Objeto de la clase Grupo con los nuevos parametros del
     * grupo que queremos modificar.
     * @param gViejo Objeto de la clase Grupo con los antiguos parametros que
     * serán modificados.
     ...
     *
     * @param temp <code>String</code> con la temporada en la que se va a ha
     * crear el grupo.
     * @param dia1 <code>String</code> con el primer dia de entrenamiento del
     * grupo.
     * @param dia2 <code>String</code> con el segundo dia de entrenamiento del
     * grupo.
     * @param hora <code>String</code> con la hora a la que entrena el grupo.
     * @param min <code>String</code> con los minutos a los que entrena el
     * grupo.
     ...
     *
     * @param cat <code>String</code> con el nombre de la categoria del grupo.
     * @param ent <code>String</code> con el nombre del entrenados que entrenará
     * al grupo.
     * @param inst <code>String</code> con el nombre de la instalacion donde
     * entrenará el grupo.
     * @param temp  <code>String</code> con la temporada en la que se va a ha
     ...
     *
     * @return Un <code>String</code> con la temporada en la que fue creado el
     * grupo.
     */
    String getTemporada() {
     ...
     *
     * @param idGrup El identificador del grupo que queremos establecer en el
     * grupo.
     */
     ...
     * objeto de la clase Grupo.
     *
     * @param idTemp El identificador de la temporada que queremos establecer en
     * el grupo.
     */
