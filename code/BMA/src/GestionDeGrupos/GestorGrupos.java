...
public class GestorGrupos {
     ...
     * aplicar como filtro.
     * @return Una lista de lista de cadenas con los grupos seleccionados
     * mediante el filtro establecido por los parametros.
     * @throws SQLException
     */
     ...
     *
     * @param accesoBD Usado para interactuar con la base de datos.
     * @param idGrupo Identificador del grupo del que queremos saber la
     * temporada.
     ...
     *
     * @param accesoBD Usado para interactuar con la base de datos.
     * @param idGrupo Identificador del grupo del que queremos saber el primer
     * dia de la semana que entrena.
     ...
     *
     * @param accesoBD Usado para interactuar con la base de datos.
     * @param idGrupo Identificador del grupo del que queremos saber el segundo
     * dia de la semana que entrena.
    ...
    /**
     * Permite obtener una lista de los alumnos introducidos en un grupo
     * concreto.
     *
     * @param accesoBD Usado para interactuar con la base de datos.
     * @param idGrupo Identificador del grupo del que queremos obtener los
     * alumnos.
     * @return Una lista de <code>String</code> con los alumnos que componen el
     * grupo.
     * @throws SQLException
     */
     ...
     *
     * @param accesoBD Usado para interactuar con la base de datos.
     * @param idGrupo Identificador del grupo del que queremos eliminar el
     * alumno.
     ...
     *
     * @param accesoBD Usado para interactuar con la base de datos.
     * @param idGrupo Identificador del grupo del que queremos saber el
     * entrenador.
     ...
     * @param listaAlumnos Lista con los alumnos que queremos modificar del
     * grupo.
     * @throws SQLException
     */
     ...
     * @return Un <code>int</code> con el identificador de la temporada del
    ...
    /**
     * Permite comprobar si un alumno ya esta dado de alta en una temporada
     * concreta.
     *
     ...
     *
     * @param accesoBD Usado para interactuar con la base de datos.
     * @param listaAlumnos Lista con los alumnos que queremos introducir en el
     * grupo.
     ...
     * @param dia1 Contiene el primer dia de entrenamiento del grupo que
     * queremos crear.
     * @param dia2 Contiene el segundo dia de entrenamiento del grupo que
     * queremos crear.
     * @param hora Contiene la hora del grupo de entrenamiento que vamos a
     * crear.
     * @param min Contiene los minutos del grupo de entrenamiento que vamos a
     * crear.
