 ...
 * @author Julio
 */
public class ModificarLiga extends javax.swing.JFrame {
    
    BaseDatos accesoBD;
    PrincipalLiga principal;
    String nom, temp, cat;
    int idLig;

    /**
     * Creates new form ModificarLiga
     */
    public ModificarLiga() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(345, 207));
        setResizable(false);

        modificarLabel.setText("Modificar Liga");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(nombreText, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createSequentialGroup()
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        ...
        if(!error){
            try {
                boolean exito = GestorLigas.modificaLiga(accesoBD, 
                        ...
                        idLig);
                if(exito){
                    JOptionPane.showMessageDialog(null, "Liga modificada con exito", "Confirmacion", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarLiga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarLiga().setVisible(true);
            }
        });
    }
