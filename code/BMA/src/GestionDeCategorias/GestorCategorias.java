...
public class GestorCategorias {
     ...
     * @param desc Contiene la descripcion de la categoria que queremos
     * insertar.
     * @param EdadMinima parametro formal de tipo int (entero) que representa la
     * edad mínima del alumno.
     * @throws SQLException
     */
    ...
    /**
     * Permite obtener una lista con las temporadas almacenadas en la base de
     * datos.
     *
     * @param accesoBD Usado para interactuar con la base de datos.
     ...
     *
     * @param accesoBD Usado para interactuar con la base de datos.
     * @param c Objeto de la clase Categoria con los datos de la categoria que
     * queremos eliminar.
     */
     ...
     *
     * @param accesoBD Usado para interactuar con la base de datos.
     * @return Una lista de <code>String</code> con los nombres de las
     * categorias.
     * @throws SQLException
     */
    ...
    /**
     * Permite obtener el año de la categoria con respecto
     * a la edad mínima.
     *
     * @param bd Usado para interactuar con la base de datos.
     * @param cat Parametro formal de tipo String (Cadena) que contiene
     * el dato de la categoria.
     * @return devuelve un entero que representa el año al que pertenecen
     * los alumnos de la categoria.
     * @throws SQLException
     */
